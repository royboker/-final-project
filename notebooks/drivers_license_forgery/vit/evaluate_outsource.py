"""
Evaluate the improved ViT-Small binary model on 999 out-of-dataset samples.
Usage: python notebooks/drivers_license_forgery/vit/evaluate_outsource.py
"""
import json
import os
import numpy as np
...
MODEL_PATH = os.path.join(PROJECT_ROOT, "notebooks/drivers_license_forgery/vit/vit_binary_improved_9996.pth")
...
def main():
    ...
    print("\n" + "=" * 60)
    print("OUT-OF-DATASET RESULTS (999 unseen samples)")
    print("=" * 60)
    ...
    if wrong:
        print(f"Top 10 most confident WRONG predictions:")
        print("-" * 80)
        for d in wrong[:10]:
