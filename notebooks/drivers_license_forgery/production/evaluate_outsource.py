...
Usage: python notebooks/drivers_license_forgery/production/evaluate_outsource.py
"""
import json
import os
import numpy as np
...
MODEL_PATH = os.path.join(PROJECT_ROOT, "notebooks/drivers_license_forgery/production/vit_binary_improved_15k.pth")
