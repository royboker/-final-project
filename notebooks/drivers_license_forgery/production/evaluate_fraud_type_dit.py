"""
Evaluate the DiT-Base fraud type classifier on out-of-dataset fake samples.
Filters test_samples.json to fakes only (666 samples: 333 morphing + 333 replacement).

Usage: python notebooks/drivers_license_forgery/production/evaluate_fraud_type_dit.py
"""
import json
import os
import numpy as np
...
MODEL_PATH = os.path.join(PROJECT_ROOT, "notebooks/drivers_license_forgery/production/dit_fraud_type_15k.pth")
...
def main():
    ...
    print("\n" + "=" * 60)
    print("OUT-OF-DATASET FRAUD TYPE RESULTS - DiT-Base 15K MODEL")
    print("=" * 60)
