...
Usage: python notebooks/drivers_license_forgery/vit_15k/prepare_splits.py
"""
import os
import pandas as pd
...
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "notebooks/drivers_license_forgery/vit_15k/data")
