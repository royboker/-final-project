"""
Evaluate the DiT-Base binary model (trained on 20K ID card dataset) on 2997 out-of-dataset samples.
Usage: python notebooks/id_card_forgery/production/evaluate_outsource_dit.py
"""
import json
import os
import numpy as np
...
MODEL_PATH = os.path.join(PROJECT_ROOT, "notebooks/id_card_forgery/production/dit_binary_20k.pth")
...
def main():
    ...
    print("\n" + "=" * 60)
    print("OUT-OF-DATASET RESULTS - DiT-Base 20K ID CARD MODEL")
    print("=" * 60)
