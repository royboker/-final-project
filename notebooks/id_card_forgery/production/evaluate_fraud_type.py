"""
Evaluate the ViT-Small fraud type classifier on out-of-dataset fake ID card samples.
Filters test_samples.json to fakes only.

Usage: python notebooks/id_card_forgery/production/evaluate_fraud_type.py
"""
import json
import os
import numpy as np
...
MODEL_PATH = os.path.join(PROJECT_ROOT, "notebooks/id_card_forgery/production/vit_fraud_type_20k.pth")
...
def main():
    ...
    print("\n" + "=" * 60)
    print("OUT-OF-DATASET FRAUD TYPE RESULTS - 20K ID CARD MODEL")
    print("=" * 60)
