"""
Evaluate the ViT-Small binary model (trained on 20K ID card dataset) on out-of-dataset samples.
Usage: python notebooks/id_card_forgery/production/evaluate_outsource.py
"""
import json
import os
import numpy as np
...
MODEL_PATH = os.path.join(PROJECT_ROOT, "notebooks/id_card_forgery/production/vit_binary_improved_20k.pth")
...
def main():
    ...
    print("\n" + "=" * 60)
    print("OUT-OF-DATASET RESULTS - 20K ID CARD MODEL")
    print("=" * 60)
