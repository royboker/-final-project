"""
Create train/val/test splits for the 20K passport dataset.
Uses GroupShuffleSplit on original_id to prevent data leakage.

Split strategy: 80/10/10.

Usage: python notebooks/passport_forgery/production/prepare_splits.py
"""
import os
import pandas as pd
...
DATASET_CSV = os.path.join(PROJECT_ROOT, "datasets/passport_20k/dataset.csv")
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "notebooks/passport_forgery/production/data")
