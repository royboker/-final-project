"""
Evaluate the ViT-Small fraud type classifier on out-of-dataset fake passport samples.
Filters test_samples.json to fakes only.

Usage: python notebooks/passport_forgery/production/evaluate_fraud_type.py
"""
import json
import os
import numpy as np
...
MODEL_PATH = os.path.join(PROJECT_ROOT, "notebooks/passport_forgery/production/vit_fraud_type_20k.pth")
...
def main():
    ...
    print("\n" + "=" * 60)
    print("OUT-OF-DATASET FRAUD TYPE RESULTS - 20K PASSPORT MODEL")
    print("=" * 60)
