"""
Evaluate the ViT-Small binary model (trained on 20K passport dataset) on out-of-dataset samples.
Usage: python notebooks/passport_forgery/production/evaluate_outsource.py
"""
import json
import os
import numpy as np
...
MODEL_PATH = os.path.join(PROJECT_ROOT, "notebooks/passport_forgery/production/vit_binary_improved_20k.pth")
...
def main():
    ...
    print("\n" + "=" * 60)
    print("OUT-OF-DATASET RESULTS - 20K PASSPORT MODEL")
    print("=" * 60)
