"""
Evaluate the DiT-Base fraud type classifier on out-of-dataset fake passport samples.
Filters test_samples.json to fakes only (1998 samples: 999 morphing + 999 replacement).

Usage: python notebooks/passport_forgery/production/evaluate_fraud_type_dit.py
"""
import json
import os
import numpy as np
...
MODEL_PATH = os.path.join(PROJECT_ROOT, "notebooks/passport_forgery/production/dit_fraud_type_20k.pth")
...
def main():
    ...
    print("\n" + "=" * 60)
    print("OUT-OF-DATASET FRAUD TYPE RESULTS - DiT-Base 20K PASSPORT MODEL")
    print("=" * 60)
