"""
Create a 20,000-image passport dataset for binary forgery detection.
Countries: ALB (Albania), GRC (Greece), LVA (Latvia)
...
# Settings
TARGET_COUNTRIES = ['ALB', 'GRC', 'LVA']
ROOT_DIR = 'datasets/idnet'
OUTPUT_DIR = 'datasets/passport_20k'
...
TEST_SAMPLES_PATH = 'notebooks/passport_forgery/experiments/test_samples.json'

RANDOM_SEED = 42


def get_folders(country_path, country_code):
    """Handle both flat (ALB/positive/) and nested (GRC/GRC/positive/) folder layouts."""
